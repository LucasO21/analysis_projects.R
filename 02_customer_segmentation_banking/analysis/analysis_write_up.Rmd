...
# * Set Working Dir ----
setwd(here::here("03_customer_segmentation_banking", "analysis"))
...
to plot the clusters in two or three dimensions, making it easier to visualize the clusters. 
...
available credit they are currently using. It is calculated by dividing the amount of
...
**Observation:** We can observe a few standout cohorts:
...
**Observation:** We can see the k-means algorithm does a good job of segmenting customers. 
While not completely perfect, we can see 4 distinct segments with a few customers that
should probably be re-clustered, although a 3 dimensional plot may present a different perspective.
...
Based on the analysis in the previous section. We can thus finalize our customer personas
