...
# Custom GGplot Theme ----
get_custom_ggplot_theme <- function(plot_title_size = 16, plot_subtitle_size = 14,
                                    y_axis_text_size = 10, x_axis_text_size = 10,
                                    y_axis_label_size = 10, x_axis_label_size = 10,
                                    x_axis_date = TRUE, x_axis_angle = TRUE) {
