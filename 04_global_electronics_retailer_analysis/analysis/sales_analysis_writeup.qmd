...
```{r echo=FALSE, fig.cap='Repeat Purchasers by Number of Unique Purchases', out.width='90%', fig.align='center'}
#| fig-pos: 'H'
...
```{r echo=FALSE, fig.cap='Average Sales Customer by Month', out.width='90%', fig.align='center'}
...
```{r echo=FALSE, fig.cap='Average Sales Customer by Month', out.width='100%', fig.align='center'}
